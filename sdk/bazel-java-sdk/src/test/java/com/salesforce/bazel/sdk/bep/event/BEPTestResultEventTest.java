...
public class BEPTestResultEventTest {
    ...
    public void testResultEventParse() throws Exception {
        ...
        assertEquals("file:///private/var/tmp/_bazel_mbenioff/8fc74f66fda297c82a847368ee50d6a4/execroot/myrepo/bazel-out/darwin-fastbuild/testlogs/foo/foo-test/test.log", 
            uri.getUri().toString());
    }
