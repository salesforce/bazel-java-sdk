 ...
 * <p>
 * This event is useful when you want to see the resolution of wildcard 
 * build targets, such as //foo/bar/... This event lists the concrete targets
 * that are resolved from the wildcard.
 */
