...
public class BEPEvent {
    ...
    /**
     * Returns the JSON String, intended to be used for debugging. Since this can  
    ...
    /**
     * Returns the JSON object, for cases in which the SDK does not model the event data that 
     * you need. Since this can take a lot of memory, you must enable this feature explicitly:<br/>
